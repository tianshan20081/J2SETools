...
public class GetWorkDayTimeMillisecond {
	...
	public static void main(String[] args) {
		...
		Long b = a.getWorkdayTimeInMillis("2010-05-01 8-00-00",
				"2010-05-18 9-00-00", "yyyy-MM-dd HH-mm-ss");
		System.out.println(b / 1000.00 / 60.00 / 60.00 / 24.00);
	}
