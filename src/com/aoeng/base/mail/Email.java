...
public class Email {
	...
	public static void main(String[] args) {
		 ...
		 ************* 切切注意********
		 */
		Email themail = new Email("smtp.126.com");// 这里以新浪邮箱为例子
		String mailbody = "<a href='http://www.baidu.com/' target='_blank'>百度</a>发送成功了哦";// 邮件正文
		themail.setNeedAuth(true);
		themail.setSubject("JAVA发邮件的测试");// 邮件主题
		themail.setBody(mailbody);// 邮件正文
		themail.setTo("zhangshch2008@qq.com,805752685@qq.com,sczhang0131@163.com,zhangshch0131@126.com");// 收件人地址
		themail.setFrom("zhangshch0131@126.com");// 发件人地址
		themail.addFileAffix("/home/paynet/Study/python/TaoBaoMeimei/pics/img0.jpg");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法；
		// 如果没有可以不写
		themail.addFileAffix("/home/paynet/Study/python/TaoBaoMeimei/pics/img1.jpg");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法；
		// 如果没有可以不写
		themail.setNamePass("zhangshch0131@126.com", "0000!@#$%^");// 发件人地址和密码
																	// **改为相应邮箱密码
		themail.sendout();
	}
	...
	public static void send(String msg) {
		...
		Email themail = new Email("smtp.126.com");// 这里以新浪邮箱为例子
		String mailbody = msg;// 邮件正文
		themail.setNeedAuth(true);
		themail.setSubject("网页爬虫－省市县乡村");// 邮件主题
		themail.setBody(mailbody);// 邮件正文
		themail.setTo("zhangshch2008@qq.com");// 收件人地址
		themail.setFrom("zhangshch0131@126.com");// 发件人地址
		themail.setNamePass("zhangshch0131@126.com", "0000!@#$%^");// 发件人地址和密码
																	// **改为相应邮箱密码
